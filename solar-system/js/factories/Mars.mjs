...
class Mars {
    constructor(scene, radiusEarth, sunRadius) {
        ...
        this.moonsInfo = [
            { name: 'Fobos', radius: 0.015*radiusEarth, texture:this.fobosTextureMap, normalMap:this.fobosNormalMap,orbitRadius: 9378,orbitSpeed: 0.001},
            { name: 'Deimos', radius: 0.0044*radiusEarth, texture:this.deimosTextureMap, normalMap:this.deimosNormalMap, orbitRadius: 23460,orbitSpeed: 0.001},
        ];
